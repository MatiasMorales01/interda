...
{
    public partial class arteriauternia : Form
    {
        conector conector = new conector();
        public arteriauternia()
        {
            InitializeComponent();
            this.Width = 800;
            this.Height = 583;
            ...
            DataTable datos = conector.leer("select * from arteriauerina");
        ...
        private void arteriauternia_Load(object sender, EventArgs e)
        {
